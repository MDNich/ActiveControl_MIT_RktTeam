...
def calculateDeltDict(or_obj, dictNew, dictOld,toPrint=False):
    ...
    if(toPrint):
        ...
        logging.warning("changeInPosition: ")
        logging.info(changeInPosition)
        logging.warning("changeInVelocity: ")
        logging.info(changeInVelocity)
        logging.warning("changeInOrientationAxis: ")
        logging.info(changeInOrientationAxis)
        logging.warning("changeInRotationVelocity: ")
        logging.info(changeInRotationVelocity)
        logging.warning("changeInOrientationAngleDeg: ")
