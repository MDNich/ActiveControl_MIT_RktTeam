...
during its flight.  The successor project of Haisunï¿½ï¿½tï¿½ included
...
original Haisunï¿½ï¿½tï¿½ rocket, consists of a schematic drawing of the
...
\caption{Dialog window for changing the simulation plot options and a
  plot of the simulated flight of the Haisunï¿½ï¿½tï¿½ hybrid rocket.}
\label{fig-plotting}
\end{figure}
